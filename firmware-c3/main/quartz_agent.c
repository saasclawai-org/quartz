...
/* === Sensor GPIO mapping === */
#if CONFIG_IDF_TARGET_ESP32 /* M5Stack Core: input-only strapping pins */
#define QZ_SENSOR_VIBRATION_ADC_CHANNEL  ADC1_CHANNEL_0  /* GPIO36 */
#define QZ_SENSOR_LIGHT_ADC_CHANNEL      ADC1_CHANNEL_3  /* GPIO39 */
#define QZ_SENSOR_VOLTAGE_ADC_CHANNEL    ADC1_CHANNEL_7  /* GPIO35 */
#define QZ_SENSOR_CURRENT_ADC_CHANNEL    ADC1_CHANNEL_6  /* GPIO34 */
#define QZ_SENSOR_DIGITAL_GPIO           36              /* GPIO36 also digital */
#elif CONFIG_IDF_TARGET_ESP32C3 /* C3 super-mini board: ADC1 ch0-4 = GPIO0-4 */
#define QZ_SENSOR_VIBRATION_ADC_CHANNEL  ADC1_CHANNEL_0  /* GPIO0  */
#define QZ_SENSOR_LIGHT_ADC_CHANNEL      ADC1_CHANNEL_1  /* GPIO1  */
#define QZ_SENSOR_VOLTAGE_ADC_CHANNEL    ADC1_CHANNEL_2  /* GPIO2  */
#define QZ_SENSOR_CURRENT_ADC_CHANNEL    ADC1_CHANNEL_3  /* GPIO3  */
#define QZ_SENSOR_DIGITAL_GPIO           4               /* GPIO4  */
#else
#error "Unsupported target — define sensor ADC channel map for this chip"
#endif
